...
public class PanelAutores extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        lbl_segundoNombre.setBackground(new java.awt.Color(0, 0, 0));
        lbl_segundoNombre.setFont(new java.awt.Font("San Francisco Text", 1, 16)); // NOI18N
        lbl_segundoNombre.setText("Segundo nombre:");

        lbl_primerApellido.setBackground(new java.awt.Color(0, 0, 0));
        lbl_primerApellido.setFont(new java.awt.Font("San Francisco Text", 1, 16)); // NOI18N
        lbl_primerApellido.setText("Primer apellido:");

        lbl_segundoApellido.setBackground(new java.awt.Color(0, 0, 0));
        lbl_segundoApellido.setFont(new java.awt.Font("San Francisco Text", 1, 16)); // NOI18N
